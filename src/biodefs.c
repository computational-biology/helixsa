...
char get_nuc_class(char* base)
{
   if(strcmp(base, "G") == 0) return 'G';
   if(strcmp(base, "DG") == 0) return 'G';
   if(strcmp(base, "C") == 0) return 'C'; 
   if(strcmp(base, "DC") == 0) return 'C';
   if(strcmp(base, "A") == 0) return 'A';
   if(strcmp(base, "DA") == 0) return 'A';
   if(strcmp(base, "T") == 0) return 'T';
   if(strcmp(base, "DT") == 0) return 'T';
   if(strcmp(base, "U") == 0) return 'U';
   if(is_guavar(base) == 1) return 'g';
   if(is_adevar(base) == 1) return 'a';
   if(is_cytvar(base) == 1) return 'c';
   if(is_uravar(base) == 1) return 'u';
